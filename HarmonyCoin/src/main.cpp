...
// HarmonyCoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Monday, 12-Jun-17 14:57:12 UTC";
        CTransaction txNew;
        txNew.nTime = 1497279432;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1497279432; //Friday, 24-Mar-17 02:44:04 UTC
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 7383267;
        if(fTestNet)
        {
            block.nNonce   = 2293752;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xe592e19dc271c84e94663300d0cd51f2005bbfcc6205776e1beb43bde06a7d69"));
        block.print();
